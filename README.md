...
* [Funcionalidades e registros (vídeos e apresentações) das sprints](#funcionalidades-e-registros-(vídeos-e-apresnetações)-das-sprints)
* [Cronograma das Sprints](#Cronograma-das-Sprints)
* [Backlog do produto](#Backlog-do-produto)
* [Competências desenvolvidas](#competências-desenvolvidas)
* [Autores](#autores)

# Projeto (API) :clipboard:
...
## Sprint 2 . 
- [x] Implementar o Python na análise dos dados​;
- [x] ​Implementar um modelo de otimização de distribuição baseado no Método de Transportes;					
- [x] Desenvolvimento total das telas do Power BI​;
- [X] Dados da produtividade;
- [x] Desenvolver gráficos interativos.
      
## Sprint 3. 
- [x] Criação do Banco de Dados MySQL para armazenamento dos dados obtidos​;
- [x] Desenvolver consultas SQL;
- [x] Conectar os painéis ao banco de dados;
...
|  Team Member  | Natali Cristine      |           [![Linkedin Badge](https://img.shields.io/badge/Linkedin-blue?style=flat-square&logo=Linkedin&logoColor=white)](https://br.linkedin.com/in/natali-santos-453949171) [![GitHub Badge](https://img.shields.io/badge/GitHub-111217?style=flat-square&logo=github&logoColor=white)](https://github.com/Ndossan1)|
